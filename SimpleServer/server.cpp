...
//#include <iomanip>
//#include <string>
////#include <fcntl.h> // windows supports this header.
//
...
//	uv_fs_read(&loop, readReq, fileHandle, &readBuf, 1, -1, on_read);
...
//	// start/stop methods.
//	
//	uv_fs_open(&loop, &openReq, "test.txt", 0, UV_FS_READ, on_open);
//
